...
let package = Package(
    ...
    products: [
        .library(name: "PresentationHome", targets: ["PresentationHome"])
    ],
    dependencies: [
        .package(path: "../../Macros"),
        .package(path: "../../Utils"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "PresentationGrid", package: "Grid"),
                .product(name: "PresentationFavorites", package: "Favorites"),
                .product(name: "PresentationAccount", package: "Account"),
                "Swinject",
